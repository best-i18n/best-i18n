...
| TanStack Start                                                            | [`best-i18n/vite` + request middleware](/docs/integrations/tanstack-start)       |
| Svelte 5 and SvelteKit                                                    | [`best-i18n/vite` with `svelte: true`](/docs/integrations/svelte)                |
| Solid and SolidStart v2                                                   | [`best-i18n/vite` with `solid: true`](/docs/integrations/solid)                  |
| Vue 3 and Nuxt 4                                                          | [`best-i18n/vite` with `vue: true`, or `best-i18n/nuxt`](/docs/integrations/vue) |
