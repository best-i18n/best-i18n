...
Supports [SolidStart v2](https://docs.solidjs.com/solid-start/v2), Solid 1 and Vite 8; SolidStart v2 itself requires Node.js 24 or newer. See the complete [`playground/solid-start`](https://github.com/best-i18n/best-i18n/tree/main/playground/solid-start).
